...
DATA_FILE_MOON = 'ephemeris/transit_data/transit_data_moon_data_compressed.json.json.gz'
DATA_FILE_SUN = 'ephemeris/transit_data/transit_data_sun_data_compressed.json.json.gz'
...
for moon_entry in moon_almanac:
    ...
    for sun_entry in sun_almanac:
        ...
        rounded_angle = round(abs(current_angle),4)
